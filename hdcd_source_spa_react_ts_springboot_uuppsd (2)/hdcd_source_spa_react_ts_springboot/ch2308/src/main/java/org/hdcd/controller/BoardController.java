...
public class BoardController {
	...
	public ResponseEntity<String> register(@Validated @RequestBody Board board, BindingResult result) throws Exception {
		...
		if(result.hasErrors()) {
			return new ResponseEntity<String>(result.getClass().getSimpleName(), HttpStatus.BAD_REQUEST);
		}
	...
	@PutMapping("/{boardNo}")
	public ResponseEntity<String> modify(@PathVariable("boardNo") long boardNo, @Validated @RequestBody Board board, BindingResult result) throws Exception {
		log.info("modify");
